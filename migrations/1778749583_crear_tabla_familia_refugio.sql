    ...
    ELSE
        IF NOT EXISTS (
            ...
            ALTER TABLE familia_refugio
                ADD COLUMN id_familia_refugio INT;
        END IF;
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE familia_refugio
                ADD COLUMN fecha_ingreso TIMESTAMP;
        END IF;
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE familia_refugio
                ADD COLUMN fecha_salida TIMESTAMP NULL;
        END IF;
        ...
        ALTER SEQUENCE familia_refugio_id_familia_refugio_seq
            OWNED BY familia_refugio.id_familia_refugio;
        ALTER TABLE familia_refugio
        ...
        ALTER TABLE familia_refugio
            ALTER COLUMN id_familia_refugio SET NOT NULL;
        ...
        IF v_pk_name IS NOT NULL AND v_pk_name <> 'familia_refugio_pkey' THEN
            EXECUTE format(
                'ALTER TABLE familia_refugio DROP CONSTRAINT %I',
                v_pk_name
            );
            v_pk_name := NULL;
        END IF;
        ...
        IF v_pk_name IS NULL THEN
            ALTER TABLE familia_refugio
                ADD CONSTRAINT familia_refugio_pkey PRIMARY KEY (id_familia_refugio);
        END IF;
